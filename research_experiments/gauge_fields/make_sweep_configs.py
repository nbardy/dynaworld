                ...
                for radius in parse_float_list(args.radii):
                    for alpha_logit in parse_float_list(args.alpha_logits):
                        if support_mode == "derived_support_metric":
                            derived_scales = parse_float_list(args.derived_support_scales)
                            derived_floors = parse_float_list(args.derived_support_floors)
                            derived_weight_taus = parse_float_list(args.derived_support_weight_taus)
                            derived_normalize_trace_values = parse_bool_list(args.derived_support_normalize_trace_values)
                        else:
