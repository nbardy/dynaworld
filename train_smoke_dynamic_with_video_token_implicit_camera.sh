...
VIDEO_LOG_EVERY="${VIDEO_LOG_EVERY:-1000}"
SIZE="${SIZE:-32}"
TRAIN_FRAME_COUNT="${TRAIN_FRAME_COUNT:-16}"
TOKENS="${TOKENS:-4}"
GAUSSIANS_PER_TOKEN="${GAUSSIANS_PER_TOKEN:-16}"
...
PATCH_COMPRESSION="${PATCH_COMPRESSION:-32}"
ENCODER_SELF_ATTN_LAYERS="${ENCODER_SELF_ATTN_LAYERS:-1}"
BOTTLENECK_SELF_ATTN_LAYERS="${BOTTLENECK_SELF_ATTN_LAYERS:-1}"
...
RUN_NAME="${RUN_NAME:-dynamic-video-token-implicit-camera-smoke}"
