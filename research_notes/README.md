...
- **`browser_stablegs_mip_ablation_design_2026-08-21.md`** — exact browser-only floater/zoom ablation contract: compensated 2D Mip math, dual opacity for glass, fused geometry color and prior-free paired depth, buffer costs, deliberate StableGS divergences, and the matched A0-A5 falsification matrix.
