...
equivalence contact sheet above and the partial progressive Coffee
Martini heldout-PSNR comparison below. They are derived from
verifier-accepted source artifacts. The remaining submission figures
are:
...
\pandocbounded{\includegraphics[keepaspectratio,alt={Heldout PSNR for the three accepted full-300-frame progressive Coffee Martini seeds. The figure does not include the missing fixed, sampler, camera-triplet, scene-breadth, or D-NeRF controls.}]{research_notes/gauged_uvt_trace_atlas/paper/figures/coffee_progressive_heldout_psnr.png}}
