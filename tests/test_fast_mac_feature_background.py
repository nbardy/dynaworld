...
from renderers.fast_mac import FastMacRendererConfig, _make_v5_features_config
...
def test_feature_background_defaults_to_zero_without_reusing_rgb_background():
    ...
    raster_config = _make_v5_features_config(config, height=8, width=8, feature_dim=32)
...
def test_feature_background_accepts_scalar_or_explicit_feature_vector():
    ...
    scalar_raster_config = _make_v5_features_config(scalar_config, height=8, width=8, feature_dim=32)
    ...
    vector_raster_config = _make_v5_features_config(vector_config, height=8, width=8, feature_dim=4)
...
def test_feature_background_rejects_wrong_vector_length_for_feature_dim():
    ...
    with pytest.raises(ValueError, match="feature_dim=32"):
        _make_v5_features_config(config, height=8, width=8, feature_dim=32)
