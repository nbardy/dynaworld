...
def format_init_diagnostic_summary(metrics: Mapping[str, float]) -> str:
    keys = (
        ...
        "InitDiag/Opacity/Mean",
        "InitDiag/Opacity/Max",
        "InitDiag/Opacity/Std",
        "InitDiag/RGB/Mean",
        "InitDiag/RGB/Min",
        "InitDiag/RGB/Max",
        "InitDiag/RGB/Std",
        "InitDiag/RGB/Entropy01",
        "InitDiag/Spread/RGB/WithinTokenRangeMean",
        "InitDiag/Spread/RGB/SameSplitCrossTokenStdMean",
        "InitDiag/Spread/RGB/CrossToWithinStdRatio",
